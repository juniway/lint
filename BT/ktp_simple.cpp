...
int solve(int x, int y, int movei, int sol[N][N], int xMove[],
                int yMove[]);
...
function mainly uses solve() to solve the problem. It returns false if
...
bool solveKT()
{
    ...
    // Initially, we set the Knight at the first block
    sol[0][0]  = 0;
